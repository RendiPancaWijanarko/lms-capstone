            ...
            <div class="card-body">
                <form action="{{ route('updateSchedule', ['schedule' => $schedule->id]) }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="class_name" id="class_name" class="form-control" required="required" value="{{ $schedule->class_name }}" placeholder="Enter class name">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="meet_link" id="meet_link" class="form-control" required="required" value="{{ $schedule->meet_link }}" placeholder="Enter Meet link">
                    </div>
